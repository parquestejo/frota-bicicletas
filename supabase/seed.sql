...
select 'C'||lpad(n::text,3,'0'),'conventional','Bicicleta convencional '||lpad(n::text,3,'0'),(select id from kiosks where name=case when n<=10 then 'Praia da Torre' else 'Terrapleno de Algés' end)
