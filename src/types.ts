...
export interface RentalItem {id:string; bike_id:string; returned_at?:string; anomaly:boolean; anomaly_description?:string; bike?:Bike; return_kiosk?:Kiosk; returned_by_user?:User}
...
export interface Fault {id:string; bike_id:string; bike?:Bike; origin:string; category:string; description:string; severity:string; usable:boolean; status:string; created_at:string; notes?:string; created_by_user?:User}
